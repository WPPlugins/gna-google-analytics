<?php
if (!class_exists('GNA_GoogleAnalytics_Config')) {
	class GNA_GoogleAnalytics_Config{
		var $configs;
		var $message_stack;
		static $_this;
		...
		function load_config() {
			$this->configs = get_option('g_analytics_configs');
		}
		...
		function save_config() {
			update_option('g_analytics_configs', $this->configs);
		}
		...
		static function get_instance(){
			if(empty(self::$_this)){
				self::$_this = new GNA_GoogleAnalytics_Config();
